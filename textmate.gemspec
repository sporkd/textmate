...
Gem::Specification.new do |s|
  ...
  s.description = %q{Command-line textmate package manager (minor additions by ddollar)}
  ...
  s.summary = %q{Command-line textmate package manager (minor additions by ddollar)}
